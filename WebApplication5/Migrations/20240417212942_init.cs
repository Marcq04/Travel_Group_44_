    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CBookingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarRentalId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarRentalBookings", x => x.CBookingId);
                    table.ForeignKey(
                        name: "FK_CarRentalBookings_Cars_CarRentalId",
            ...
            migrationBuilder.CreateTable(
                name: "CarRentalComments",
                schema: "Identity",
                columns: table => new
                {
                    CarRentalCommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarRentalComments", x => x.CarRentalCommentId);
                    table.ForeignKey(
                        name: "FK_CarRentalComments_Cars_CarRentalId",
                        column: x => x.CarRentalId,
                        principalSchema: "Identity",
                        principalTable: "Cars",
                        principalColumn: "CarRentalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FBookingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightBookings", x => x.FBookingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelBookings", x => x.HBookingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarRentalComments_CarRentalId",
                schema: "Identity",
                table: "CarRentalComments",
                column: "CarRentalId");
